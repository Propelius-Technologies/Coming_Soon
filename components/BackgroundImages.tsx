const BackgroundImages=()=>{
    return(
        <div>
          ...
          <img src='/images/man.png' className='absolute top-[19em] right-9 xl:top-[19rem] 2xl:block xl:block lg:block  xl:right-[11rem] xl:w-[300px] 2xl:top-[20rem] 2xl:right-[20rem] lg:w-[250px] lg:right-0 md:w-[200px] hidden min-[2560px]:right-[25rem] min-[2560px]:top-[39rem] min-[2560px]:w-[400px]  min-[2560px]:right-[] ' />
